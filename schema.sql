...
CREATE TABLE sections (
  ...
  FOREIGN KEY (PageID) REFERENCES restaurants(PageID),
...
BEGIN
  ...
  populate_loop: REPEAT
    ...
    INSERT into sections (PageID, Name, Category) VALUES (@Counter, "Non-Alcoholic Drinks", "Brunch");
    INSERT into sections (PageID, Name, Category) VALUES (@Counter, "Beers", "Brunch");
